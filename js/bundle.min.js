...
$(document).ready(function(){var a=function(a,e){$(a).typeIt({strings:e,speed:100,lifeLike:!1,cursor:!0})};a(".header__title.type-it",["Joel Mercier","Développeur web"]),$("#barba__wrapper").on("click",'a[href*="#"]:not([href="#"])',function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var a=$(this.hash);if(a=a.length?a:$("[name="+this.hash.slice(1)+"]"),a.length)return $("html, body").animate({scrollTop:a.offset().top},1e3),!1}}),wow=new WOW({boxClass:"wow",animateClass:"animated",offset:0,mobile:!1,live:!0}),wow.init();var e=skrollr.init({forceHeight:!1,skrollrBody:"top"});$("#barba__wrapper").on("mouseover",".portfolio__link",function(a){var e=$(".portfolio__image"),o=$(this).parent().data("img");e.css("background-image","url("+o+")"),e.stop().fadeIn(500)}),$("#barba__wrapper").on("mouseleave",".portfolio__link",function(a){var e=$(".portfolio__image"),o="webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend";e.stop().fadeOut(500),e.one(o,function(){e.css("background-image","")})}),Barba.Pjax.Dom.wrapperId="barba__wrapper",Barba.Pjax.Dom.containerClass="barba__container",Barba.Pjax.ignoreClassLink="barba__link--ignored",Barba.Prefetch.init(),Barba.Pjax.start(),Barba.Dispatcher.on("newPageReady",function(o,n,r){a(".header__title.type-it",["Joel Mercier","Développeur web"]),e.refresh()})});